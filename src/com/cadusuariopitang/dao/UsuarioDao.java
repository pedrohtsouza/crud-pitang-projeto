package com.cadusuariopitang.dao;
...
import com.cadusuariopitang.bean.Usuario;
...
public class UsuarioDao {
	...
	public static Connection getConnection() {
		...
		try {
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/cadusuariopitang","root","");
			}catch(Exception e) {
